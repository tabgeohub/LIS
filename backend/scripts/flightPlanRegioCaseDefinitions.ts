...
export const FLIGHT_PLAN_REGIO_CASES: FlightPlanCase[] = [
  ...
  { name: "GET /templateFlight", build: (regio) => buildFlightPlanQuery({ planTable: "lis.template_plans", planAlias: "tp", columnPreset: "template", pointPreset: "template", includeGeometryJoin: true, regio_id: regio, regioColumn: "tp.regio_id", regioFilter: { caseInsensitiveAdmin: true } }) },
