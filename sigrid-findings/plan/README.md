...
**Source:** `exported-findings-5` · Open code security RAW: **1** (WP-07 remark only)
...
5. **[Maintainability-Architecture/](./Maintainability-Architecture/)** — MAINT + ARCH (1052 RAW)
...
Uses `sigrid-findings/exported-findings-5/` by default. Override: `SIGRID_EXPORT_DIR=path/to/export`.
