  ...
  return (
    <div
      ...
      className={classNames(
        "hover:bg-blue-50 hover:border-blue-200 cursor-pointer text-center grid grid-rows-2 justify-center text-gray-400 group border-2 transition-all duration-300 rounded-xl",
        selectedTab === item.id
