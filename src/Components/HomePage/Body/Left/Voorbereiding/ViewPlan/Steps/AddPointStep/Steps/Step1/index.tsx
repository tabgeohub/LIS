...
import SearchWidget from "Components/HomePage/Body/Left/Voorbereiding/EnrichedAddPoint/Common/SearchWidget";
  ...
  return (
    <div>
      <p className="text-gray-800 leading-3 text-[12px] h-full">
        {content.voorbereiding.vluchtplanInformatie.addPointStep.step1.text1}
      </p>
        ...
        <div className="flex gap-x-1 text-[12px]">
          <button
            onClick={() => {
              ...
              logAction({
                message: "User clicked 'Vorige' button",
                step: "First step",
              });
            }}
      ...
      {showText && (
        <div className="flex items-center gap-x-2 my-4">
          ...
          <p className="text-[12px]">
            {
              content.voorbereiding.vluchtplanInformatie.addPointStep.step1
                .text2
            }
          </p>
        </div>
