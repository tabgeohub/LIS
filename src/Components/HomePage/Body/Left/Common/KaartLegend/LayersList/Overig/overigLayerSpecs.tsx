...
export function createOverigLayerSpecs() {
  return [
    {
      id: "8.5", title: "Windturbenes", checked: false,
      icon: <GiWindTurbine />,
    ...
    {
      id: "8.6", title: "Vakken zandwinning", checked: false,
    ...
    {
      id: "8.7", title: "Vegunde vlakken zandwinning", checked: false,
      layer: new FeatureLayer({
      ...
      icon: <div className="w-[70%] aspect-square bg-yellow-400 border border-black" />,
      regio: ["MN"],
    },
    {
      id: "8.8", title: "Luchtvaartgebieden", checked: false,
      layer: new WMSLayer({
    ...
    {
      id: "8.9", title: "Natura2000", checked: false,
      layer: new WMSLayer({
      ...
      icon: <div className="w-[70%] aspect-square bg-green-200 border border-black" />,
      regio: ["WNN", "WNZ"],
    },
  ];
}
